  ...
  public: {
    Tables: {
      ...
      bayut_listings: {
        ...
        Relationships: [
          {
            foreignKeyName: "bayut_listings_villa_id_fkey"
            columns: ["villa_id"]
            isOneToOne: false
            referencedRelation: "community_villas"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      community_villas: {
        Row: {
          backs_park: boolean | null
          backs_road: boolean | null
          bedrooms: number | null
          ...
          is_single_row: boolean | null
          land_usage: string | null
          latitude: number | null
          longitude: number | null
          metadata: Json | null
          near_community_center: boolean | null
          near_entrance: boolean | null
          near_pool: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "community_villas_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "community_villas_plot_id_fkey"
            columns: ["plot_id"]
            isOneToOne: false
      ...
      villa_owners: {
        ...
        Relationships: [
          {
            foreignKeyName: "villa_owners_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "villa_owners_villa_id_fkey"
            columns: ["villa_id"]
            isOneToOne: false
            referencedRelation: "community_villas"
            referencedColumns: ["id"]

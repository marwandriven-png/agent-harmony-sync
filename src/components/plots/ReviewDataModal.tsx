...
export function ReviewDataModal({ isOpen, onClose, matches }: ReviewDataModalProps) {
  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div className={`relative bg-card flex flex-col animate-in fade-in duration-200 z-[10000] ${isMaximized ? 'fixed inset-0 h-screen max-h-screen' : 'w-[90vw] h-[85vh] max-h-[85vh] rounded-xl shadow-2xl'
        }`}>
        {/* Header */}

            ...
            <div className="flex gap-1 bg-muted/50 p-1 rounded-xl">
                {sections.map((section) => (
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg transition-all ${activeSection === section.id
                        ...
                        <div className="flex items-start justify-between mb-4">
                            <div>
                                ...
                                <div className="flex gap-2 flex-wrap">
                                    ...
                                    <span className={`px-2 py-1 rounded-lg text-xs ${plot.status === 'Frozen' ? 'bg-destructive/20 text-destructive' :
                    ...
                    <div className="glass-card p-4" style={{
                        ...
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="text-right">
                                ...
                                <div className={`text-2xl font-bold ${feasibility.riskLevel === 'Low' ? 'text-success' :

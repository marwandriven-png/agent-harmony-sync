...
export function LandMatchingWizard({
  ...
  return (
    <div className="fixed inset-y-0 right-[340px] w-[420px] z-[1100] flex animate-in slide-in-from-right duration-300">
      <div className="relative w-full h-full bg-[hsl(220,25%,7%)] border-l border-border/50 flex flex-col shadow-2xl">
        {/* Header */}
              ...
              {inputMode === 'form' && (
                ...
                >
                  ...
                  <p className="text-[10px] text-center text-muted-foreground">
                    Minimum: Area name, Land Size, or GFA — press Enter to search
                  </p>
                </form>
              )}
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm mb-2">
                    <div>
                      ...
                      <span className="ml-1 font-semibold text-foreground">
                        {result.matchedPlotArea > 0 ? `${result.matchedPlotArea.toLocaleString()} m²` : '—'}
                      </span>
                    ...
                    <div>
                      ...
                      <span className="ml-1 font-medium text-foreground">
                        {result.matchedGfa > 0 ? `${result.matchedGfa.toLocaleString()} m²` : '—'}
                      </span>
                    ...
                    <div>
                      ...
                      <span className="ml-1 font-medium text-foreground">{result.matchedZoning || '—'}</span>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Status:</span>
                      <span className="ml-1 font-medium text-foreground">{result.matchedStatus || '—'}</span>
                    </div>
                  </div>
